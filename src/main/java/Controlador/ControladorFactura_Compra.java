...
public class ControladorFactura_Compra implements ActionListener, DocumentListener {
    ...
    public void ver_Factura(int fact) {
        ...
        detallefactura.getTxtfactura().setText(String.valueOf(fact));
        detallefactura.getTxtproveedor().setText(dato[1]);
        detallefactura.getTxtusuario().setText(dato[2]);
        detallefactura.getTxttipopago().setText(dato[6]);
        detallefactura.getTxtcomprobante().setText(dato[7]);
        detallefactura.getTxtfecha().setText(dato[3]);
        detallefactura.getTxtimpuesto().setText(dato[5]);
        detallefactura.getTxtvalorpagar().setText(dato[4]);
